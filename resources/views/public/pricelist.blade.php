...
<section class="container mx-auto px-4 py-16">
    <h1 class="font-serif text-4xl text-black mb-8">Pricelist & Add-on</h1>
    <div class="grid lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            @foreach ($serviceCategories as $category)
                <article class="card-premium">
                    <h2 class="font-semibold text-xl text-black">{{ $category->name }}</h2>
        ...
        <aside class="card-premium h-fit">
            <h2 class="font-semibold text-xl text-black">Add-on</h2>
